import React, { lazy, Suspense, useEffect } from "react"; // Suspense is the component so start with capital letter, it is used to handle the lazy loading
...
const AppLayout = () => {
  ...
  return (
    ...
    // We need to provide our redux store to our application. how? using Provider
    // Thisprovidr has been exported from react redux library, it takes appStore as prop. that appStore will be imported from our utils
    <Provider store={appStore}>
      <UserContext.Provider value={{ loggedInUser: userName, setUserName }}>
        {/* // now inaise my whle app i can get my name as "kamal ramesh" because i provided for whole app by wrapping it out with UserContext.Provider */}
        <div className="app">
